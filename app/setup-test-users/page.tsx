...
const TEST_USERS: Array<{
  ...
  { name: 'Leonie', email: 'Leonie@algomate.local', displayName: 'Leonie', age: 24, location: 'Geneva', latitude: 46.2044, longitude: 6.1432, bio: 'Musician and music producer in Geneva creative scene. Plays guitar and keyboard, working on electronic music projects. Enjoys exploring hidden city spots and photography.', gender: 'female', genderFilter: 'all', ageFilter: 'all', friendMinAge: 18, friendMaxAge: 99, distanceFilter: 'all', maxDistance: 80 },
  ...
  { name: 'Theodor', email: 'Theodor@algomate.local', displayName: 'Theodor', age: 42, location: 'Lucerne', latitude: 47.0502, longitude: 8.3093, bio: 'Chef and food critic who runs a small restaurant. Cooking is life. loves classical music, opera, and theater. Looking for friends who appreciate good food and cultural outings.', gender: 'male', genderFilter: 'all', ageFilter: 'all', friendMinAge: 18, friendMaxAge: 99, distanceFilter: 'all', maxDistance: 80 },
  { name: 'Lukas', email: 'Lukas@algomate.local', displayName: 'Lukas', age: 26, location: 'Winterthur', latitude: 47.4979, longitude: 8.7243, bio: 'Fitness trainer and football coach. Plays football twice a week and hits the gym daily. Enjoys sports analytics and follows Swiss football closely.', gender: 'male', genderFilter: 'all', ageFilter: 'all', friendMinAge: 18, friendMaxAge: 99, distanceFilter: 'all', maxDistance: 40 },
