...
const TEST_USER_PROFILES: Record<string, Omit<Profile, 'userId'>> = {
  ...
  'Leonie@algomate.local': { displayName: 'Leonie', age: 24, location: 'Geneva', latitude: 46.2044, longitude: 6.1432, bio: 'Musician and music producer in Geneva creative scene. Plays guitar and keyboard, working on electronic music projects. Enjoys exploring hidden city spots and photography.', friendSex: 'Female', friendMinAge: 22, friendMaxAge: 35, maxDistance: 80 },
  ...
  'Theodor@algomate.local': { displayName: 'Theodor', age: 42, location: 'Lucerne', latitude: 47.0502, longitude: 8.3093, bio: 'Chef and food critic who runs a small restaurant. Cooking is life. Also loves classical music, opera, and theater. Looking for friends who appreciate good food and cultural outings.', friendSex: 'Male', friendMinAge: 35, friendMaxAge: 60, maxDistance: 80 },
  'Lukas@algomate.local': { displayName: 'Lukas', age: 26, location: 'Winterthur', latitude: 47.4979, longitude: 8.7243, bio: 'Fitness trainer and football coach. Plays football twice a week and hits the gym daily. Enjoys sports analytics and follows Swiss football closely.', friendSex: 'Male', friendMinAge: 22, friendMaxAge: 40, maxDistance: 40 },
  ...
  'Helena@algomate.local': { displayName: 'Helena', age: 27, location: 'Lugano', latitude: 46.0037, longitude: 8.9511, bio: 'Psychologist and avid reader who leads a monthly book club. Loves yoga and walking in nature to decompress from work intensity.', friendSex: 'Female', friendMinAge: 24, friendMaxAge: 38, maxDistance: 60 },
